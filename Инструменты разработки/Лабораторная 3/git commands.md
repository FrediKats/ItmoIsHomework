...
- [ ] [checkout](https://git-scm.com/docs/git-checkout) - переключение между ветками
    ...
    - `--conflict=<style>` - перегружает merge.conflictStyle
    - `-p`/`--patch` - показывает изменения, итеративно предлагая применить 
...
- [remote](https://git-scm.com/docs/git-remote) - управление удалёнными репозиториями 
    - отображает все связанные удаленные репозитории
