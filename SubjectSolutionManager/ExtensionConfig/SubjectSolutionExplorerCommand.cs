...
namespace SubjectSolutionManager.ExtensionConfig
{
    ...
    internal sealed class SubjectSolutionExplorerCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubjectSolutionExplorerCommand"/> class.
        ...
        {
            // Switch to the main thread - the call to AddCommand in SubjectSolutionExplorerCommand's constructor requires
            // the UI thread.
