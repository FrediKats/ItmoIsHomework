...
namespace Lab4
{
    class Program
    {
        ...
        private static void TestSinglePrediction(MLContext mlContext)
        {
            ...
            var predictionFunction = loadedModel.MakePredictionFunction<HouseSell, HouseSellPricePrediction>(mlContext);

            var houseSellSample = new HouseSell()
            {
                VendorId = "VTS",
                RateCode = "1",
                PassengerCount = 1,
            ...
            var prediction = predictionFunction.Predict(houseSellSample);
            Console.WriteLine($"**********************************************************************");
